...
FALLBACK_QUESTIONS = {
    ...
    "记忆": [
        ...
        "想到一位孙辈或晚辈，您还记得他最近在忙什么吗？记不清也没关系。",
...
# ============================================================
# Follow-up questions that remain easy for older adults to answer
# ============================================================
FOLLOW_UP_QUESTIONS = [
    "好，我知道了。这种情况常发生吗？",
    "明白了。您昨晚睡得好吗？",
